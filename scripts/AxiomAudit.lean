...
def headlineDecls : List Name :=
  [-- Unit 1: Baire/Cantor finite-observation layer
   ...
   ``ComputableAnalysis.ratBracket_of_masks,
   ``ComputableAnalysis.exists_indices_gap,
   ``ComputableAnalysis.exists_contSetMassCode,
   ...
   ``ComputableAnalysis.exists_certFires,
   ``ComputableAnalysis.openOf_eq_iUnion_basisOpen,
   ``ComputableAnalysis.rightInverse_union,
   ``ComputableAnalysis.exists_basisRightInverseCode,
