...
/-! #### Evaluation of finite atomic measures, and the same-atoms LP bound -/
...
difference. -/
private theorem levyProkhorovDist_le_sum_abs {k : ℕ} (x : Fin k → X) (a b : Fin k → ℝ)
    (hb : ∀ i, 0 ≤ b i) (Pμ Qμ : ProbabilityMeasure X)
